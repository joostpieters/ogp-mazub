...
public class Facade implements IFacadePart3{
     ...
     * specified sprites.
     *
     * @param pixelLeftX   The x location of the bottom left pixel of Buzam
     * @param pixelBottomY The y location of the bottom left pixel of Buzam
     * @param sprites      The sprites to be used by Buzam (following the same structure
     */
    @Override
     ...
     * @param y       The y-coordinate of the plant's initial position
     * @param sprites An array of sprites for the new plant
     * @param program The programs that this plant should execute, or null if the
     ...
     * @param y       The y-coordinate of the shark's initial position
     * @param sprites An array of sprites for the new shark
     * @param program The programs that this shark should execute, or null if the
     ...
     * @param sprites An array of sprites for the new slime
     * @param school  The initial school to which the new slime belongs
     * @param program The programs that this slime should execute, or null if the
     ...
     *
     * @param world The world to which Buzam should be added.
     * @param buzam
     */
    @Override
     ...
     *
     * @param alien The alien of which to find the location
     * @return An array, consisting of 2 integers {x, y}, that represents the
     * coordinates of the given alien's bottom left pixel in the world.
     */
    @Override
